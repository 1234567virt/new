...
class UsersApi extends Api
{
     ...
     * http://ДОМЕН/product + параметры запроса , email
     * @return string
     */
     ...
     * http://ДОМЕН/product/1 + параметры запроса market, data
     * @return string
     */
    public function updateAction()
    {
        ...
        $name = $this->requestParams['market'] ?? '';
        $email = $this->requestParams['data'] ?? '';
